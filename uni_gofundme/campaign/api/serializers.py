...
class CampaignModelSerializer(serializers.ModelSerializer):
    ...
    status_type     = serializers.CharField(max_length=25, default="Waiting for approval",required=False)
    class Meta:
        model = CampaignModel
        fields = [
                  'title',
    ...
    def set_attributes(self, validated_data):
        obj = {"title" :        validated_data['title'],
               ...
               "status_id":     validated_data['status_type'],
    ...
    def update(self, update_obj, validated_data):
        ...
        obj['created_by_id'] = update_obj[0].created_by_id
